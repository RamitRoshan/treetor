...
const companies = [
  ...
  { name: 'MultiplyingBrics', isImage: true, src: '/MultiplyingBrics.png', alt: 'MultiplyingBrics logo', imgClass: 'h-10 md:h-12 scale-[1.8] md:scale-[2] hover:scale-[1.9] md:hover:scale-[2.1] invert hue-rotate-180 brightness-125 dark:invert-0 dark:hue-rotate-0 dark:brightness-100' },
