...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-white dark:bg-brand-forest/50 pt-16 pb-8 border-t border-brand-forest/5 dark:border-brand-beige/10 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <motion.div 
            ...
            className="lg:col-span-2 lg:ml-8"
          >
